...
function tie_register() {
    ...
    }elseif (tie_get_option('jquery_cdn') == 'baidu') {
      $jquery_cdn = '//libs.baidu.com/jquery/1.8.3/jquery.min.js';
    }elseif (tie_get_option('jquery_cdn') == 'sae') {
    ...
    } elseif (tie_get_option('jquery_cdn') == 'upyun') {
      $jquery_cdn = '//upcdn.b0.upaiyun.com/libs/jquery/jquery-1.8.3.min.js';
    }elseif (tie_get_option('jquery_cdn') == 'qiniu') {
      $jquery_cdn = '//cdn.staticfile.org/jquery/1.8.3/jquery.min.js';
    }
    wp_register_script( 'jquery',$jquery_cdn, false,'20131120' );
    wp_enqueue_script( 'jquery' );
