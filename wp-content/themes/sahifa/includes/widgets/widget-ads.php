...
class ads125_widget extends WP_Widget {
	function ads125_widget() {
		...
		$this->WP_Widget( 'ads125-widget',theme_name .' - 广告 125*125', $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			...
			<br /><small>如果启用此项标题将消失</small>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'new_window' ); ?>">在新窗口打开:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'one_column' ); ?>">一列:</label>
		...
		<?php 
		for($i=1 ; $i<11 ; $i++ ){ ?>
		<em style="display:block; border-bottom:1px solid #CCC; margin:20px 0 5px; font-weight:bold">广告 <?php echo $i; ?> :</em>
		<p>
			<label for="<?php echo $this->get_field_id( 'ads'.$i.'_img' ); ?>">广告 <?php echo $i; ?> 图片路径 :  </label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'ads'.$i.'_url' ); ?>">广告 <?php echo $i; ?> 链接 : </label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'ads'.$i.'_code' ); ?>"><strong> 或者： </strong> 广告 <?php echo $i; ?> 联盟代码 </label>
...
class ads120_90_widget extends WP_Widget {
	function ads120_90_widget() {
		...
		$this->WP_Widget( 'ads120_90-widget',theme_name .' - 广告 120*90', $widget_ops, $control_ops );
	}
...
class ads120_60_widget extends WP_Widget {
	function ads120_60_widget() {
		...
		$this->WP_Widget( 'ads120_60-widget',theme_name .' - 广告 120*60', $widget_ops, $control_ops );
	}
...
class ads120_600_widget extends WP_Widget {
	function ads120_600_widget() {
		...
		$this->WP_Widget( 'ads120_600-widget',theme_name .' - 广告 120*600', $widget_ops, $control_ops );
	}
...
class ads120_240_widget extends WP_Widget {
	function ads120_240_widget() {
		...
		$this->WP_Widget( 'ads120_240-widget',theme_name .' - 广告 120*240', $widget_ops, $control_ops );
	}
...
class ads160_600_widget extends WP_Widget {
	function ads160_600_widget() {
		...
		$this->WP_Widget( 'ads160_600-widget',theme_name .' - 广告 160*600', $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'ads'.$i.'_img' ); ?>">Ads  图片路径 :  </label>
			<input id="<?php echo $this->get_field_id( 'ads'.$i.'_img' ); ?>" name="<?php echo $this->get_field_name( 'ads'.$i.'_img' ); ?>" value="<?php  if( !empty( $instance['ads'.$i.'_img'] ) ) echo $instance['ads'.$i.'_img']; ?>" class="widefat" type="text" />
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'ads'.$i.'_url' ); ?>">Ads  链接 : </label>
			<input id="<?php echo $this->get_field_id( 'ads'.$i.'_url' ); ?>" name="<?php echo $this->get_field_name( 'ads'.$i.'_url' ); ?>" value="<?php if( !empty( $instance['ads'.$i.'_url'] ) ) echo $instance['ads'.$i.'_url']; ?>" class="widefat" type="text" />
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'ads'.$i.'_code' ); ?>"><strong> 或者： </strong> Ads 联盟代码 </label>
			<textarea id="<?php echo $this->get_field_id( 'ads'.$i.'_code' ); ?>" name="<?php echo $this->get_field_name( 'ads'.$i.'_code' ); ?>" class="widefat" ><?php if( !empty( $instance['ads'.$i.'_code'] ) ) echo $instance['ads'.$i.'_code']; ?></textarea>
		</p>
	<?php
	}
...
class ads300_600_widget extends WP_Widget {
	function ads300_600_widget() {
		...
		$this->WP_Widget( 'ads300_600-widget',theme_name .' - 广告 300*600', $widget_ops, $control_ops );
	}
...
class ads250_250_widget extends WP_Widget {
	function ads250_250_widget() {
		...
		$this->WP_Widget( 'ads250_250-widget',theme_name .' - 广告 250*250', $widget_ops, $control_ops );
	}
...
class ads300_100_widget extends WP_Widget {
	function ads300_100_widget() {
		...
		$this->WP_Widget( 'ads300_100-widget',theme_name .' - 广告 300*100', $widget_ops, $control_ops );
	}
...
class ads300_250_widget extends WP_Widget {
	function ads300_250_widget() {
		...
		$this->WP_Widget( 'ads300_250-widget',theme_name .' - 广告 300*250', $widget_ops, $control_ops );
	}
