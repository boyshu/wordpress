...
class tie_author_custom extends WP_Widget {
	...
	function tie_author_custom() {
		...
		$this->WP_Widget( 'author-custom-widget',theme_name .' - 自定义作者内容', $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<p><em style="color:red;">这个小工具只出现在单独文章页 .</em></p>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'center' ); ?>">居中内容  :</label>
