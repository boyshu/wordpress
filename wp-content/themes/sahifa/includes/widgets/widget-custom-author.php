...
class tie_Author_Bio extends WP_Widget {
	...
	function tie_Author_Bio() {
		...
		$this->WP_Widget( 'author-bio-widget',theme_name .' - 自定义作者个人资料', $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'img' ); ?>">头像 : </label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'text_code' ); ?>">关于 : <i>你可以使用简码</i></label>
