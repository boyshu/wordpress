...
class tie_comments_avatar extends WP_Widget {
	...
	function tie_comments_avatar() {
		...
		$this->WP_Widget( 'comments_avatar-widget',theme_name .' - 最新评论带头像', $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'avatar_size' ); ?>"> 头像大小 : </label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'no_of_comments' ); ?>">显示评论数量:  </label>
