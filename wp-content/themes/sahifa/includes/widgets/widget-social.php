...
class tie_social_widget extends WP_Widget {
	...
	function tie_social_widget() {
		...
		$this->WP_Widget( 'social',theme_name .' - 社会化图标', $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			...
			<br /><small>如果选择，此活动的标题将消失</small>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'newtap' ); ?>">在新标签页中打开链接 :</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'icons_size' ); ?>">图标大小 : </label>
