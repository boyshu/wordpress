...
class tie_widget_tabs extends WP_Widget {
	function tie_widget_tabs() {
		$widget_ops = array( 'description' => '通过滑动门选项卡显示，热门文章，最新文章，最新评论以及标签'  );
		$this->WP_Widget( 'widget_tabs',theme_name .'- 滑动选项卡  ', $widget_ops );
	}
...
<?php
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'posts_number' ); ?>">显示条目数量 : </label>
