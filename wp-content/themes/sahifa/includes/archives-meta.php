...
<?php if( tie_get_option( 'arc_meta_author' ) ): ?>		
	<span><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) )?>" title="<?php sprintf( esc_attr__( '查看 %s 的所有文章', 'tie' ), get_the_author() ) ?>"><?php echo get_the_author() ?> </a></span>
<?php endif; ?>	
...
<?php if( tie_get_option( 'arc_meta_comments' ) ): ?>
	<span><?php comments_popup_link( __( '发表评论', 'tie' ), __( '1条评论', 'tie' ), __( '% 条评论', 'tie' ) ); ?></span>
<?php endif; ?>
</p>
