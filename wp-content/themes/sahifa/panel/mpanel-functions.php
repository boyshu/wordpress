	...
	if ( get_option('tie_active') == 4.1 && isset( $_GET['page'] ) && $_GET['page'] == 'panel' && !get_user_meta( $userid, 'ignore_sample_error_notice2' ) ) {
		echo '<br />
			<div class="updated" style="width:790px; margin:0 auto; padding:0 10px; overflow:hidden;">
				<p style="float:left;"><strong>如果您对于 Sahifa v4.0 有什么问题.. </strong>
				<a target="_blank" href="http://themes.tielabs.com/docs/sahifa/sahifa4.htm">请点击 Sahifa v4.0 FAQ常见问题 .</a></p>
<a target="_blank" href="http://www.luoxiao123.cn">
咨询汉化相关问题，请到逍遥乐汉化 逍遥乐IT博客 .</a></p>
				<div class="tie-pointer-buttons"><a class="close" href="admin.php?page=panel&dismiss_me=yes">离开</a></div>
			</div>';
	}
}
...
if ( isset( $_GET['page'] ) && $_GET['page'] == 'panel' ) {
	...
	function tie_pointer_print_scripts() {
		...
		$pointer_content  = "<h3>你喜欢 ".theme_name." ?</h3>";
		$pointer_content .= "<p> 如果你喜欢 ".theme_name." 主题, 请不要忘记 <a href=\'http://themeforest.net/downloads?ref=mo3aser\' target=\'_blank\'><strong>给它的评价</strong></a>，逍遥乐汉化，如果您对这个
汉化满意，请进行捐赠，您的捐助就是我继续汉化的动力o <a href=\'https://me.alipay.com/xiaoyaole' target=\'_
blank\'><strong>支付宝捐赠</strong></a> :)</p>";
	?>
...
function tie_add_admin() {
	...
	$theme_page = add_submenu_page('panel',theme_name.' 设置', theme_name.' 设置','switch_themes', 'panel' , 'panel_options');
	add_submenu_page('panel', "导入演示数据" , "导入演示数据" ,'switch_themes', 'tie_demo_installer' , 'tie_demo_installer');
	add_submenu_page('panel',theme_name.' 帮助文档（外链）', '帮助文档（外链）','switch_themes', 'docs' , 'redirect_docs');
