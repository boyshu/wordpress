...
<form id="GalleryShortcode">
	...
	<p>
		<label for="Boxalign">框对齐 :</label>
		<select id="Boxalign" name="Boxalign">
			<option value=""></option>
			<option value="alignright">右</option>
			<option value="alignleft">左</option>
			<option value="aligncenter">中</option>
		</select>
	</p>
	<p>
		<label for="BoxClass">自定义 Class :</label>
		<input id="BoxClass" name="BoxClass" type="text" value="" />
	</p>
	</p>
	<p>
		<label for="BoxWidth">框宽度 :</label>
		<input id="BoxWidth" name="BoxWidth" type="text" value="" />
	</p>
	<p>
		<label for="BoxContent">内容 : </label>
		<textarea id="BoxContent" name="BoxContent" col="20"></textarea>
	</p>
	<p><a class="add" href="javascript:AddBoxes.insert(AddBoxes.e)">插入文章</a></p>
</form>
...
<form id="GalleryShortcode">
	<p>
		<label for="ButtonColor">添加按钮:</label>
	...
	<p>
		<label for="Buttonsize">按钮大小 :</label>
	...
	<p>
		<label for="Buttonlink">按钮链接  :</label>
		<input id="Buttonlink" name="Buttonlink" type="text" value="http://" />
	</p>
	<p>
		<label for="Buttontarget">在新窗口打开 : </label>
	...
	<p><a class="add" href="javascript:AddButtons.insert(AddButtons.e)">插入文章</a></p>
</form>
...
<form id="GalleryShortcode">
	<p>
		<label for="image">作者图像 URL</label>
	...
	<p><a class="add" href="javascript:Author.insert(Author.e)">插入文章</a></p>
</form>
...
<?php } elseif( $page == 'flickr' ){ ?>
	...
	<title>从Flickr添加照片</title>

</head>
<body>
<form id="GalleryShortcode">
	<p>
		<label for="FlickrID">你的帐户 Id</label>
		<input id="FlickrID" name="FlickrID" type="text" value="" />
		<small>(获取 <a href="http://www.idgettr.com">idGettr</a>)</small>

	</p>
	<p>
		<label for="Photos">照片数量:</label>
		<input id="Photos" name="Photos" type="text" value="" />

	</p>
	<p>
		<label for="PhotosOrder">排序: </label>
		<select id="PhotosOrder" name="PhotosOrder">
			<option value="latest">最新</option>
			<option value="random">随机选择</option>
		</select>
	</p>
	<p><a class="add" href="javascript:AddFlickr.insert(AddFlickr.e)">插入文章</a></p>
	</form>
...
<?php } elseif( $page == 'audio' ){ ?>
	...
	<title>添加的Mp3播放器</title>

</head>
<body>
<form id="GalleryShortcode">
	<p>
		<label for="mp3Url">Mp3 文件地址 : </label>
		<input id="mp3Url" name="mp3Url" type="text" value="" />
	</p>
	<p>
		<label for="m4aUrl">M4A 文件地址 : </label>
		<input id="m4aUrl" name="m4aUrl" type="text" value="" />
	</p>
	<p>
		<label for="oggUrl">OGG 文件地址 : </label>
		<input id="oggUrl" name="oggUrl" type="text" value="" />
	</p>

	
	<p><a class="add" href="javascript:AddAudio.insert(AddAudio.e)">插入文章</a></p>
</form>
	...
	<script type="text/javascript">
			...
			insert: function createGalleryShortcode(e) {
				...
				output += "][tabs_head]";
				 ...
				 jQuery("input[id^=tab_title]").each(function() {
					output +='[tab_title]'+jQuery(this).val()+'[/tab_title]';
				});
				
   				output += "[/tabs_head]";

				 jQuery("textarea[id^=Content]").each(function() {
					output +='[tab]'+jQuery(this).val()+'[/tab]';
				});
		...
		jQuery(document).ready(function() {
			jQuery("#add-tab").click(function() {
				jQuery('#TabsShortcodeContent').append('<p><label for="tab_title[]">选项卡标题le</label><input id="tab_title[]" name="tab_title[]" type="text" value="" /></p><p><label for="Content[]">选项卡内容</label><textarea  style="height:100px;  width:400px;" id="Content[]" name="Content[]" type="text" value=""></textarea></p>	<hr style="border-bottom: 1px solid #FFF;border-top: 1px solid #ccc; border-left:0; border-right:0;" />');
			});
		});
...
<form id="GalleryShortcode">
	...
	<p><a class="add" href="javascript:toggle.insert(toggle.e)">插入文章</a></p>
</form>
...
<?php } elseif( $page == 'twitter' ){ ?>
	...
	<title>添加最新Tweets</title>

</head>
<body>
<form id="GalleryShortcode">
	<p>
		<label for="TwitterID">用户名</label>
		<input id="TwitterID" name="TwitterID" type="text" value="" />

	</p>
	<p>
		<label for="tweets">tweets数量 :</label>
		<input id="tweets" name="tweets" type="text" value="" />

	</p>
	<p>
		<label for="avatar">显示头像 : </label>
		<input id="avatar" name="avatar" type="checkbox" value="true" />
	</p>
	
	<p><a class="add" href="javascript:AddTwitter.insert(AddTwitter.e)">插入文章</a></p>
</form>
...
<form id="GalleryShortcode">
	<p>
		<label for="feedurl">RSS订阅地址</label>
		<input id="feedurl" name="feedurl" type="text" value="" />

	</p>
	<p>
		<label for="numberFedds">订阅数量 :</label>
...
<form id="GalleryShortcode">
	<p>
		<label for="ImgUrl">完整图片或Youtube / Vimeo视频URL : </label>
	...
	<p>
		<label for="ImgContent">内容 : </label>
		<textarea id="ImgContent" name="ImgContent" cols="45" rows="5" ></textarea>
	</p>
	
	<p><a class="add" href="javascript:Addlightbox.insert(Addlightbox.e)">插入文章</a></p>
</form>
...
<form id="GalleryShortcode">
	<p>
		<label for="VideoUrl" style="width:230px">视频地址 :</label>
		<input id="VideoUrl" name="VideoUrl" type="text" value="http://" />
		<br /><small>支持 : YouTube, Vimeo, Viddler, Qik, Hulu, FunnyOrDie, DailyMotion, WordPress.tv and blip.tv</small>
	</p>
	<p>
	...
	<p><a class="add" href="javascript:AddVideo.insert(AddVideo.e)">插入文章</a></p>
</form>
...
<form id="GalleryShortcode">
	<p>
		<label for="MapUrl">地图地址 : </label>
		<input id="MapUrl" name="MapUrl" type="text" value="http://" />

	</p>
	<p>
		<label for="Mapalign">地图对齐 :</label>
		<select id="Mapalign" name="Mapalign">
			<option value=""></option>
			<option value="alignright">右</option>
			<option value="alignleft">左/option>
			<option value="aligncenter">中</option>
	...
	<p><a class="add" href="javascript:googlemap.insert(googlemap.e)">插入文章</a></p>
</form>
	...
	<script type="text/javascript">
		var toggle = {
			...
			insert: function createGalleryShortcode(e) {
				...
				var feedburner = jQuery('#feedburner');
				var feedburnerName = jQuery('#feedburnerName').val();
				if(feedburner.is(":checked")) {
					output += '[feedburner name="'+feedburnerName+'"]';
				}
...
<form id="GalleryShortcode">
	...
	<p>
		<label for="Facebook"><strong>Facebook喜欢按钮n</strong></label>
		<input id="Facebook" name="Facebook" type="checkbox" value="true" />
	</p>
	<hr style="border-bottom: 1px solid #FFF;border-top: 1px solid #ccc; border-left:0; border-right:0;" />

	<p>
		<label for="tweet"><strong>Tweet 按钮</strong></label>
		<input id="tweet" name="tweet" type="checkbox" value="true" />
	</p>
	<hr style="border-bottom: 1px solid #FFF;border-top: 1px solid #ccc; border-left:0; border-right:0;" />
	<p>
		<label for="digg"><strong>Digg 按钮</strong></label>
		<input id="digg" name="digg" type="checkbox" value="true" />
	</p>
	<hr style="border-bottom: 1px solid #FFF;border-top: 1px solid #ccc; border-left:0; border-right:0;" />
	<p>
		<label for="stumble"><strong>Stumble 按钮</strong></label>
		<input id="stumble" name="stumble" type="checkbox" value="true" />
	</p>
	<hr style="border-bottom: 1px solid #FFF;border-top: 1px solid #ccc; border-left:0; border-right:0;" />
	<p>
		<label for="Google"><strong>Google+ 按钮</strong></label>
		<input id="Google" name="Google" type="checkbox" value="true" />
	</p>
	<hr style="border-bottom: 1px solid #FFF;border-top: 1px solid #ccc; border-left:0; border-right:0;" />
	<p>
		<label for="feedburner"><strong>Feedburner 按钮</strong></label>
		<input id="feedburner" name="feedburner" type="checkbox" value="true" />
		<input id="feedburnerName" name="feedburnerName" type="Text" value="Feed Name" />
	</p>
	<hr style="border-bottom: 1px solid #FFF;border-top: 1px solid #ccc; border-left:0; border-right:0;" />
	<p>
		<label for="pinterest"><strong>Pinterest 按钮</strong></label>
		<input id="pinterest" name="pinterest" type="checkbox" value="true" />
	</p>
	<hr style="border-bottom: 1px solid #FFF;border-top: 1px solid #ccc; border-left:0; border-right:0;" />
	<p>
		<label for="TwitterID"><strong>Twitter Follow 按钮</strong></label>
	...
	<p>
		<label for="Large">Large 按钮 : </label>
		<input id="Large" name="Large" type="checkbox" value="true" />
	</p>
	<p>
		<label for="count">显示计数 : </label>
